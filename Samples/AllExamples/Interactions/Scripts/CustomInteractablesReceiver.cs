...
namespace HoloLight.STK.Examples.Interactions
{
    ...
    /// in InteractableReceiverList or InteractableReceiver (this is used at InteractionsContent/NearInteractionSample
    /// 
    ...
    public class CustomInteractablesReceiver : ReceiverBase
    {
        ...
        private void SetOutput()
        {
            if (Host != null)
            {
                TextMeshPro mesh = Host.GetComponentInChildren<TextMeshPro>();
